...
use App\Http\Repositories\Admin\GameRepository;
use Exception;
...
class GameService
{
    ...
    {
        try {
            $result = $this->game_repository->whereFirst($column, $value);
            if(!$result) {
                return null;
            }
            return $result;
    ...
    public function toggleGameStatus($data)
    {
        $this->game_repository->toggleActive($data);
    }
}

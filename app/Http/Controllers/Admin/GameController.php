...
use App\Http\Requests\Admin\Game\ListingRequest;
...
class GameController extends ApiController
{
    ...
    public function index(ListingRequest $request)
    {
        try {
            ...
            $res_data = $this->game_service->getDataWithPagination($per_page, $page, status: $status, searches: $searches);
    ...
    public function toggleActive($id)
    {
        try {
            ...
            $data = $this->game_service->whereFirst('id', $id);
            if ($data) {
                $this->game_service->toggleGameStatus($data);

...
use App\Http\Requests\User\PaymentMethod\ListingRequest;
use App\Http\Services\User\PaymentMethodService;
...
class PaymentMethodController extends ApiController
{
    ...
    public function index(ListingRequest $request)
    {
        try {
            ...
            $res_data = $this->payment_method_service->getDataWithPaginationCached($per_page, $page, status: $status, searches: $searches);
